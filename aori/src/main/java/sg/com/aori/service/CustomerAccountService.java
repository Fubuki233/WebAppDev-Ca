 ...
 * This will interact with the Service Interface and Controller.
 * 
 * @author Ying Chun
 * @date 2025-10-08
 * @version 1.0 - Previously named CsutomerProfileService
...
public class CustomerAccountService implements ICustomerAccount {
	...
	public Customer updateCustProfile(String customerId, Customer profileData) {
		...
		// Update customer's profile details for each field, encapsulated by the 'profileData' object
