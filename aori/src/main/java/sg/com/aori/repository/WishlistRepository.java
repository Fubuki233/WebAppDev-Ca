...
public interface WishlistRepository extends JpaRepository <Wishlist, WishlistId> {
	...
	// returns deleted row count | 0 -> product not in wishlist, 1-> product existed and was removed from wishlist
	int deleteByCustomerIdAndProductId (String customerId, String productId);
