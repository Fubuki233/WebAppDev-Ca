...
public class WishlistController {
	...
	//toggles customer's wishlist. returns added:true if newly added, added:false if removed
	@PostMapping("/toggle")
	...
	//checks if a product is already in a customer's wishlist. returns exists:true/false
	@GetMapping("/exists")
