...
public interface IProductReview {
    /**
     * Create or update a review for the given (customerId, orderId, orderItemId).
     * Business rules:
    ...
    /**
     * Get the existing review for this customer & the product inside the given order item (if any).
     */
