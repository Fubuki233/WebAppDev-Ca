                    ...
                    <div className="payment-form-section">
                        ...
                        <form onSubmit={handlePayment}>
                            ...
                            <div className="payment-methods">
                                ...
                                <label className={`payment-method-option ${paymentMethod === 'PayLah!' ? 'selected' : ''}`}>
                                    <input
                                        type="radio"
                                        name="paymentMethod"
                                        value="PayLah!"
                                        checked={paymentMethod === 'PayLah!'}
                                        onChange={(e) => setPaymentMethod(e.target.value)}
                                    />
                                    <div className="method-info">
                                        <span>PayLah!</span>
                            ...
                            {paymentMethod === 'PayLah!' && (
                                <div className="PayLah!-message">
                                    <p>You will be redirected to PayLah! to complete your payment.</p>
                                </div>
                            )}
